            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor mb-0 mt-0">Pedidos</h3>
                        <ol class="breadcrumb">
                            ...
                            <div class="card-body">
                                ...
                                <form id='form-filter-document' method='post' action='#'>
                                	<div class='row'>
		                                                ...
		                                                <option value="" selected>Selecione...</option>
		                                                    <?php
		                                            			...
		                                            			foreach($status as $stat) {
		                                            				$selected = $req_status == $stat->getId() ? "selected" : "";
		                                            				echo "<option value='" . $stat->getId() . "' $selected>" . $stat->getName() . "</option>";
		                                            			}
				                                            ?>
		                                            </select>
		                                        </div>
                                		...
                                		<div class='col-md-3'>
		                                    <div class="form-group">
		                                        <label for="req_date_from">Data inicial</label>
		                                        <input id='req_date_from' name='req_date_from' type="date" class="form-control" value="<?php echo isset($date_from) ? $date_from : ""; ?>">
		                                    </div>
                                		</div>
                                		<div class='col-md-3'>
		                                    <div class="form-group">
		                                        <label for="req_date_to">Data final</label>
		                                        <input id='req_date_to' name='req_date_to' type="date" class="form-control" value='<?php echo isset($date_to) ? $date_to : ""; ?>'>
		                                    </div>
                                		</div>
                                    	<div class='col-md-3'>
	                                		<div class="form-group">
		                                        <div class="controls">
		                                            ...
		                                            <select id='req_user' name='req_user' class="form-control">
		                                                <option value="" selected>Selecione...</option>
		                                                    <?php
                                		...
                                		<div class='col-md-3'>
		                                    <div class="form-group">
		                                    	<div class='controls'>
			                                        <label for="doc_year">Ano do documento</label>
			                                        <input id='doc_year' name='doc_year' type="number" class="form-control" placeholder="0" min='1' value=''>
		                                    	</div>
		                                    </div>
                                		</div>
                                	</div>
    ...
    <script>
        $(document).ready(function() {
        	var tbRequests = $('#data-table-basic').DataTable({
            	...
            	"aaSorting": [2, "desc"],
            	"language" : {
            	    "sEmptyTable": "Nenhum pedido encontrado",
            	    "sInfo": "Mostrando de _START_ até _END_ de _TOTAL_ pedidos",
            	    "sInfoEmpty": "Mostrando 0 até 0 de 0 pedidos",
            	    "sInfoFiltered": "(Filtrados de _MAX_ pedidos)",
            	    "sInfoPostFix": "",
            	    "sInfoThousands": ".",
            	    "sLengthMenu": "_MENU_ resultados por página",
            	    "sLoadingRecords": "Carregando...",
            	    "sProcessing": "Processando...",
            	    "sZeroRecords": "Nenhum pedido encontrado",
            	    "sSearch": "Pesquisar",
            	    "oPaginate": {
            	        "sNext": "Próximo",
            	        "sPrevious": "Anterior",
            	...
            	"sAjaxSource": "./core/data-tables/TableRequests.php",
            	"sServerMethod" : "POST",
            	"fnServerParams" : function(aoData) {
            		aoData.push(
        				{"name": "req_number", "value" : $("#req_number").val()},
        				{"name": "req_date_from", "value" : $("#req_date_from").val()},
        				{"name": "req_date_to", "value" : $("#req_date_to").val()},
        				{"name": "req_user", "value" : $("#req_user").val()},
        				{"name": "doc_number", "value" : $("#doc_number").val()},
        				{"name": "doc_year", "value" : $("#doc_year").val()},
        				{"name": "req_status", "value" : $("#req_status").val()},
            	...
            	"aoColumnDefs" : [{
	                    ...
	                    "mRender": function(d,t,f) {
		                    var href = "visualizar_pedido_caixas.php?r=" + d;
		                    if(f[7] == <?= RequestType::DOCUMENT ?>) href = "visualizar_pedido_documentos.php?r=" + d;
	                    	return "<a href='" + href + "' class='btn btn-circle btn-primary waves-effect'><i class='fa fa-eye'></i></a>";
                        }
                    }, {
                        "aTargets": [2],
                        width: 140,
