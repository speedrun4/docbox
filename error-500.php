    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <h3 class="text-uppercase error-subtitle">ERRO INTERNO DO SERVIDOR</h3>
                <p class="text-muted mt-4 mb-4">O servidor está com dificuldade de processar a sua requisição. Se o erro persistir entre em contato com o administrador do site.</p>
                <a href="<?= "https://" . $_SERVER['SERVER_NAME'] . "/"; ?>" class="btn btn-info btn-rounded waves-effect waves-light mb-5">Voltar ao início</a> </div>
        </div>
    </div>
    <!-- ============================================================== -->
    <!-- All Required js -->
