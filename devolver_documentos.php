                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Devolver documentos</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
					...
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								...
								<h6 class="card-subtitle">Marque documentos que deseja devolver</h6>
    ...
    $(function() {
    	var _language = {
        	...
        	var tbDocuments = $('#data-table-basic').DataTable({
            	...
            	"aaSorting" : [4, "asc"],
            	"language" : _language,
            	"sAjaxSource" : "./core/data-tables/TableDocsRequested.php",
            	"sServerMethod" : "POST",
        ...
        $("#btConfirmDevolution").click(function() {
			if(listRequestDocIds.length > 0) {
				swal({
        			title: 'Deseja realmente realizar a devolução dos documentos?',
        			text: "",
        			type: 'question',
        			...
        			if(result.value) {
	    				$.post("./core/actions/registerDocumentDevolution.php", {"ids" : listRequestDocIds}, function(data) {
	  			        	if(data.ok) {
	  			        		window.location.href = "visualizar_devolucao_documentos.php?dev=" + data.dev_id;
	  			        	} else {
