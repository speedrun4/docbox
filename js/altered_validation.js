                ...
                return this.each(function () {
                    ...
                    $this.bind("validation.validation", function (event, params) {
                        ...
                        $.each(validators, function (validatorType, validatorTypeArray) {
                            if (value || (value != null && value.length) || ((params && params.includeEmpty) || !!settings.validatorTypes[validatorType].includeEmpty) || (!!settings.validatorTypes[validatorType].blockSubmit && params && !!params.submitting)) {
        ...
        , validatorTypes: {
            callback: {
                ...
                , validate: function ($this, value, validator) {
                    ...
                    if(Array.isArray(validator.lastValue) && Array.isArray(value)) {
                        if(validator.lastFinished && validator.lastValue.length === value.length && validator.lastValue.sort().every(function(_value, _index) { return _value === value.sort()[_index]})) {
                            return !validator.lastValid;
                        }
                    }*/
                    if (validator.lastFinished === true || validator.firstTime) {
            ...
            , required: {
                ...
                , validate: function ($this, value, validator) {
                    return !!((value != null && value.length === 0 && !validator.negative) || (value != null && value.length > 0 && validator.negative));
                }
                , blockSubmit: true
            }
            , match: {
