    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <h3 class="text-uppercase error-subtitle">ACESSO NEGADO</h3>
                <p class="text-muted mt-4 mb-4">Você não tem permissão de acesso a este recurso, solicite o acesso ao administrador do site.</p>
