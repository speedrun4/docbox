                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Auditoria de caixas</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Exibe número sequenciais faltantes</h6>
        ...
        $(document).ready(function() {
        	tbDocuments = $('#data-table-basic').DataTable({
            	...
            	"language":{
            	    ...
            	    "sInfo": "Mostrando _END_ faltantes em _TOTAL_ caixas",
            	...
            	"sAjaxSource": "./core/data-tables/TableFaultingDocs.php",
            	"sServerMethod": "POST",
