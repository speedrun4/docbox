...
if($devolution == NULL || $devolution->getReqType() != RequestType::BOX) {
	header("Location: login.php");
}
?>
<!DOCTYPE html>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Esta tabela exibe as caixas da devolução</h6>
                                <div class="table-responsive m-t-40">
                                    <table id="data-table-basic" class="table table-bordered table-striped">
		                                ...
		                                <tbody>
		                                <?php
											if($devolution->getReqType() == RequestType::BOX) {
												$i = 0;
												$boxes = $devolutionController->getBoxesFromDevolution($devolution);
            	...
            	"aoColumnDefs" : [
            		{
	                	...
	                	"mRender": function(d,t,f) {
		                	return "<a href='visualizar_pedido_caixas.php?r=" + f[0] + "'>" + d + "</a>";
	                	}
	            	}
                ]
            });
